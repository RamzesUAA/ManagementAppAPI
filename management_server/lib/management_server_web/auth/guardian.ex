defmodule ManagementServerWeb.Auth.Guardian do
  use Guardian, otp_app: :management_server
  alias ManagementServer.Accounts
  # ManagementServerWeb.Auth.Guardian.authenticate("first_account@gmail.com", "our_password")
