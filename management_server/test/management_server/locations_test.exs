defmodule ManagementServer.LocationsTest do
  ...
  describe "locations" do
    ...
    test "create_location/1 with valid data creates a location" do
      valid_attrs = %{address: "some address", location: %{}, name: "some name"}
    ...
    test "update_location/2 with valid data updates the location" do
      location = location_fixture()
      update_attrs = %{address: "some updated address", location: %{}, name: "some updated name"}
